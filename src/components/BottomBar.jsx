        ...
        return (
            <div>
                <label>
                    ...
                    <img src="icons/MedalGold.svg" width={55} height={55} />
                </label>
                ...
                <label>
                    ...
                    <img src="icons/WinningPercentage.svg" width={55} height={55} />
                </label>
                ...
                <label>
                    ...
                    <img src="icons/TotalMedals.svg" width={55} height={55} />
                </label>
                ...
                <label>
                    ...
                    <img src="icons/ExtraTopic.svg" width={55} height={55} />
                </label>
                ...
                <label>
                    ...
                    <img src="icons/RefreshNEW.svg" width={55} height={55} />
                </label>
    ...
    return (
        <div>
            ...
            <label>
                ...
                <img src="icons/Silver.svg" width={55} height={55} />
            </label>
            ...
            <label>
                ...
                <img src="icons/MedalBronze.svg" width={55} height={55} />
            </label>
